      ...
      calculatedProps.actions = calculatedProps.actions
        ...
        .map((action) => {
          if (
            ...
            if (typeof action === 'function') { return { action, position: 'toolbarOnSelect' } } else return { ...action, position: 'toolbarOnSelect' };
          } else if (action.isFreeAction) {
            if (typeof action === 'function') { return { action, position: 'toolbar' } } else return { ...action, position: 'toolbar' };
          } else return action;
        });
    } else {
      calculatedProps.actions = calculatedProps.actions
        ...
        .map((action) => {
          if (
            ...
            if (typeof action === 'function') { return { action, position: 'row' } } else return { ...action, position: 'row' };
          } else if (action.isFreeAction) {
            if (typeof action === 'function') { return { action, position: 'toolbar' } } else return { ...action, position: 'toolbar' };
          } else return action;
        });
